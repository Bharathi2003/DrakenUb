...
Owner_info_msg = f"""
<strong>Owner</strong> - Bharathi
<strong>OwnerID</strong> - <code> @Kmax_01 </code>

<strong>Message Forwards</strong> - {udB.get("PMBOT")}

<strong>Draken <a href=https://github.com/Bharathi2003/Ultroid>[v{ultroid_version}]</a>, powered by @Kmax_01</strong>
"""
...
async def ultroid(event):
    ...
    if str(event.sender_id) not in owner_and_sudos():
        ...
        if not udB.get("STARTMSG"):
            ...
            await event.reply(
                f"Hey there [{get_display_name(u)}](tg://user?id={u.id}), this is Draken Assistant of [{ultroid_bot.me.first_name}](tg://user?id={ultroid_bot.uid})!\n\n{ok}",
